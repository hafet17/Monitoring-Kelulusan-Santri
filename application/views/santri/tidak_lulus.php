...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Halaman Santri Tidak Lulus</h1>

    </div>

    <div class="row">
        <div class="col-md-4">
            <?= form_open('santri/tidak_lulus'); ?>
    ...
    <div class="col-md-4 text-center">
      ...
      <div class="dropdown float-right">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a class="dropdown-item" href="<?= base_url('export/santri_tidak_lulus_pdf'); ?>">PDF</a>
          <a class="dropdown-item" href="<?= base_url('export/santri_tidak_lulus_excel'); ?>">Excel</a>
        </div>
      </div>
        </div>
    </div>
...
<div class="table-responsive mt-4">
  ...
  <?php foreach($santriNLulus as $santri): ?>
    ...
    <th scope="col"><?= ++$start; ?></th>
      ...
      <th scope="col"><?= $santri['rata_rata']; ?></th>
      <th scope="col"><?= $santri['keterangan']; ?></th>
    </tr>
  <?php endforeach; ?>
  </tbody>
</table>
