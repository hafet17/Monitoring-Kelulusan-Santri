<?php $i = 0; ?>
<div class="container">
	<h3 class="text-center mt-3 mb-2 font-weight-bold" style="color: black !important;">Daftar Santri Lulus I'dadiyah Nurul Jadid <?= date('Y'); ?></h3>
	
	<table style="color: black !important; margin-right: 0px; !important; position: relative !important;" class="mt-4 table" cellspacing="0" cellpadding="0" border="1" bordercolor="#0000">
